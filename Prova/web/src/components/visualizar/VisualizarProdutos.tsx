...
import { Produto_Model } from "../../models/models";
...
const VisualizarProdutos = () => {
    ...
    const [result, setResult] = useState<Produto_Model[]>([]);
                            ...
                            <>
                                <div key={index}>
                                    <tr style={{ borderColor: 'maroon', borderWidth: '0 0 1px 5px', display: 'grid', gridTemplateColumns: 'repeat(12, 1fr)', alignItems: 'center' }}>
                                        ...
                                        <th className="fs-5" style={{ gridColumn: '1/6', textAlign: 'justify', marginLeft: '5%' }}>{item.etiqueta}</th>
